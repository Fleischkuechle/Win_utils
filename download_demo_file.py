...
fileURL = "https://drive.usercontent.google.com/download?id=1GijsBB7ImGuyXm2QEcegVeG9bNBHt664&export=download&authuser=0&confirm=t&uuid=4abf52a3-f8fe-4c70-b624-a9e1f2a69031&at=APZUnTW5dJsY3cnP_xDoaiHfdCal%3A1715439634835"
filename = "Demo_With_Astra_From_Mixamo.blend"
script_dir = os.getcwd()
output_folder_path = os.path.join(script_dir, "BackendCoreClassLib", "BlendFile")
full_file_path:str=""
